...
const DepartmentList =() => {
    ...
    /** 검색 버튼에 대한 클릭 이벤트 */
    // 성능 최적화를 위해 이벤트 함수에 uesCallback()을 적용함
    ...
    /** 수정사항 저장 버튼이 클릭되었을 때 호출된 이벤트 핸들러 */
    // 성능 최적화를 위해 useCallback()적용함
        ...
        (async()=>{
            ...
            if(json !== null){
                ...
                setDepartment(department => {
                    ...
                    // 원본 상태값의 해당 인텍스 번호 (find)위치부터 1개의 ajax로 반환받은 수정 결과 데이터로 교체한다.
