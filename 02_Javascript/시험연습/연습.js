...
const num = new Rectangle(10,5);

console.log('둘레의 길이는 %d이고 넓이는 %d입니다', num.getAround(), num.getArea());
...
class Student{
    ...
    sayHello(){
        console.log('나는 %s학과 %d학번 입니다.', this.department, this.number);
    }
}
const std = new Student("art", 12);
std.sayHello();
...
const acc = new Account("Leeah",5000)
acc.deposit(3000);
console.log('%s의 잔액은 %d 입니다',acc.owner, acc.balance);
