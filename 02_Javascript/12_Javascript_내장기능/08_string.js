 ...
 * foo. 메서드()
 * 
 * 문자열 객체에 내장된 메서드들은 변수가 담고 있는 내용을 가공하거나 특정 내용을 추철하는 기능을 갖는다.
...
// 기능을 확인하기 위한 문자열의 선언
const msg = "Life is too short, You need Javscript.";
console.log("문자열:" + msg);
...
//파라미터로 전달된 내용이 처음 나타내는 위치를 리턴한다.
...
// 단 이 위치를 문자열의 끝에서 부터 세는 것이 아니라 문자열을 처을부터 센다.
// 찾지 못할 경우 -1을 반환.
